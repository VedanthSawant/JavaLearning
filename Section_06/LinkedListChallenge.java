...
public class LinkedListChallenge {
	public static void main(String[] args) {
		...
		Place adalaide = new Place("Adalaide", 1374);
		addPlace(placeTovisit, adalaide);
		addPlace(placeTovisit, new Place("adalaide", 1374));
		...
		while(!quitLoop) {
			...
			switch(menuItem) {
				case "F":
					...
					break;
				case "B":
					System.out.println("User wants to go backword");
					if(forward) {
						forward = false;
						if(iterator.hasPrevious()) {
